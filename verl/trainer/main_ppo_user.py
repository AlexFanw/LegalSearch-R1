...
from verl.trainer.ppo.ray_trainer_user import RayPPOTrainer
from verl.trainer.ppo.reward import load_reward_manager
from verl.utils.device import is_cuda_available
from verl.utils.import_utils import load_extern_type


@hydra.main(config_path="config", config_name="ppo_trainer_user", version_base=None)
def main(config):
...
class TaskRunner:
    ...
    def run(self, config):
        ...
        from verl.trainer.ppo.ray_trainer_user import ResourcePoolManager, Role
