...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def __init__(self, config: DictConfig, role: str, **kwargs):
        ...
        if self._is_actor:
            ...
            # print(f"ppo_mini_batch_size after x rollout.n: {self.config.actor.ppo_mini_batch_size}")
            self.config.actor.ppo_mini_batch_size //= self.device_mesh.size() // self.ulysses_sequence_parallel_size
            # print(f"device_mesh.size(): {self.device_mesh.size()}")
            # print(f"ulysses_sequence_parallel_size: {self.ulysses_sequence_parallel_size}")
            # print(f"ppo_mini_batch_size after / world_size: {self.config.actor.ppo_mini_batch_size}")
